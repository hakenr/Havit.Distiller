...
namespace Havit.Distiller.Entity
{
	...
	public class DistillerDesignTimeDbContextFactory : IDesignTimeDbContextFactory<DistillerDbContext>
	{
		public DistillerDbContext CreateDbContext(string[] args)
		{
			...
			return new DistillerDbContext(new DbContextOptionsBuilder<DistillerDbContext>().UseSqlServer(connectionString).Options);
		}
	}
}