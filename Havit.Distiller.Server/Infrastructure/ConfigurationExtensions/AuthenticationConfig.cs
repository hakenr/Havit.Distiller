...
using Havit.Distiller.WebAPI.Infrastructure.Security;
...
namespace Havit.Distiller.WebAPI.Infrastructure.ConfigurationExtensions
{
    public static class AuthenticationConfig
    {
        ...
        {
            services.Configure<Havit.Distiller.WebAPI.Infrastructure.Security.JwtBearerSettings>(configuration.GetSection("AppSettings:JwtBearer"));
            JwtBearerSettings jwtBearerSettings = configuration.GetSection("AppSettings:JwtBearer").Get<Havit.Distiller.WebAPI.Infrastructure.Security.JwtBearerSettings>();
			//OpenIdConnectSettings openIdConnectSettings = configuration.GetSection("AppSettings:OpenIdConnect").Get<Havit.Distiller.WebAPI.Infrastructure.Security.OpenIdConnectSettings>();
