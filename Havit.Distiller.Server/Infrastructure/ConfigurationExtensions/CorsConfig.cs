...
namespace Havit.Distiller.WebAPI.Infrastructure.ConfigurationExtensions
{
    public static class CorsConfig
    {
        ...
        {
            services.Configure<Havit.Distiller.WebAPI.Infrastructure.Cors.CorsOptions>(configuration.GetSection("AppSettings:Cors"));
            services.AddCors();
        }

        public static void UseCustomizedCors(this IApplicationBuilder app, IOptions<Havit.Distiller.WebAPI.Infrastructure.Cors.CorsOptions> corsOptions)
        {
